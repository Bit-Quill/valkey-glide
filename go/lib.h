 ...
 */
const struct ConnectionResponse *create_client_using_protobuf(const uint8_t *connection_request_bytes,
...
// TODO doc
void command(void * client, uintptr_t callback_id, uint32_t request_type, uintptr_t arg_count, const char * const * args);
