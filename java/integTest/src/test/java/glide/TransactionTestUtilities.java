    ...
    private static Object[] sortedSetCommands(BaseTransaction<?> transaction) {
        ...
        var expectedResults =
                new Object[] {
                    ...
                    0L, // zinter(new KeyArray(new String[] {zSetKey2, zSetKey1}))
                    0L, // zinter(new KeyArray(new String[] {zSetKey2, zSetKey1}), Aggregate.MAX)
                    0L, // zinterWithScores(new KeyArray(new String[] {zSetKey2, zSetKey1}))
                    0L, // zinterWithScores(new KeyArray(new String[] {zSetKey2, zSetKey1}), Aggregate.MAX)
