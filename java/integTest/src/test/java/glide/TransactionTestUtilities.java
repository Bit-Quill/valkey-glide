...
public class TransactionTestUtilities {
    ...
    private static Object[] scriptingAndFunctionsCommands(BaseTransaction<?> transaction) {
        ...
        transaction
                ...
                .fcallReadOnly("myfunc1T", new String[0], new String[] {"a", "b"})
                .fcallReadOnly("myfunc1T", new String[] {"a", "b"})
        ...
        return new Object[] {
            ...
            "a", // fcallReadOnly("myfunc1T", new String[0], new String[]{"a", "b"})
            "a", // fcallReadOnly("myfunc1T", new String[] {"a", "b"})
