...
public interface SetBaseCommands {
     ...
     * @param keys The keys of the sets.
     * @return The cardinality of the intersection result. If one or more sets do not exist, 0 is
     *     returned.
     * @example
     *     <pre>{@code
     ...
     *
     * Long response2 = client.sintercard(new String[] {"set1", "nonExistingSet"}).get();
     * assert response2 == 0;
     * }</pre>
     */
     ...
     * @return The cardinality of the intersection result. If one or more sets do not exist, 0 is
     *     returned. If the intersection cardinality reaches <code>limit</code> partway through the
     *     computation, returns <code>limit</code> as the cardinality.
     * @example
     *     <pre>{@code
