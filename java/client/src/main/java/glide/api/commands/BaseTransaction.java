...
public abstract class BaseTransaction {
    ...
    public abstract static class BaseTransactionBuilder {
         ...
         */
        public BaseTransactionBuilder customCommand(String[] args) {
         ...
         */
        public BaseTransactionBuilder ping() {
         ...
         */
        public BaseTransactionBuilder ping(String msg) {
         ...
         */
        public BaseTransactionBuilder info() {
         ...
         * @return CompletableFuture with the response
         */
        public BaseTransactionBuilder info(InfoOptions options) {
         ...
         */
        public BaseTransactionBuilder get(String key) {
         ...
         * @return null
         */
        public BaseTransactionBuilder set(String key, String value) {
         ...
         */
        public BaseTransactionBuilder set(String key, String value, SetOptions options) {
            createOrAddCommand(Command.set(key, value, options.toArgs()));
            return this;
        }

        protected void createOrAddCommand(Command command) {
